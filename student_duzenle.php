...
<body>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div style="width: 730px;" class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					...
					$sorgu = $con->query("SELECT * FROM student WHERE id =".(int)$_GET['id']); //id değeri ile düzenlenecek verileri veritabanından alacak sorgu
					...
					if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
						...
						if ($code<>"" && $name<>"" && $surname<>"" ) { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
							
							if ($con->query("UPDATE student SET code = '$code', name = '$name', surname = '$surname'  WHERE id =".$_GET['id'])) // Veri güncelleme sorgumuzu yazıyoruz.
							{

									header("location:student_process.php"); 
							}
							else
							{
