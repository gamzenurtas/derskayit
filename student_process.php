			...
			<div style="width: 730px;" class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<div class="container">
							...
							if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
								...
								if ($code<>"" && $name<>"" && $surname<>"" ) { // Veri alanlarının boş olmadığını kontrol ettiriyoruz. başka kontrollerde yapabilirsiniz.
									
									if ($con->query("INSERT INTO student (code, name, surname) VALUES ('$code','$name','$surname')")) // Veri ekleme sorgumuzu yazıyoruz.
									{
							...
							$sorgu = $con->query("SELECT * FROM student"); // lecture tablosundaki tüm verileri çekiyoruz.
							...
							?>
								...
								<tr>
									...
									<td><a href="student_duzenle.php?id=<?php echo $id; ?>"  class="btn btn-primary">Düzenle</a></td>
									<td><a href="student_sil.php?id=<?php echo $id; ?>"  class="btn btn-danger">Sil</a></td>
								</tr>
