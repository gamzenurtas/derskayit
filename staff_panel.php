...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			...
			<a href="logout.php">Çıkış
				<form class="login100-form validate-form">
					
					<div class="container-login100-form-btn">
						<img style="width: 60%;height: 100%;" src="img/logo.png">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<a href="course_process.php" class="login100-form-btn">
					...
					<div style="margin-top: 10px;" class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<a href="facultymember_process.php" class="login100-form-btn">
					...
					<div style="margin-top: 10px;" class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<a href="classroom_process.php" class="login100-form-btn">
					...
					<div style="margin-top: 10px;" class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
							<a href="student_process.php" class="login100-form-btn">
